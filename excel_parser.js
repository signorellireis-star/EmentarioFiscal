...
1. Para cada link classificado como 'Lei':
   ...
   - Corpo: 2 parágrafos concisos com os pontos-chave em negrito (**destaque**):
	 ...
	 * 5º Parágrafo: Caso a lei mencione em algum local sobre palavras como "PRODUTOS ELETRÔNICOS, ELETROELETRÔNICOS, ELETRODOMÉSTICOS, MATERIAIS ELÉTRICOS, PAPÉIS, PLÁSTICOS, PRODUTOS CERÂMICOS E VIDROS,BEBIDAS ALCOÓLICAS, EXCETO CERVEJA E CHOPE, PRODUTOS DE PAPELARIA, MATERIAIS DE CONSTRUÇÃO E CONGÊNERES, FERRAMENTAS, LÂMPADAS, PRODUTOS DE PERFUMARIA E DE HIGIENE PESSOAL E COSMÉTICOS", destacar que a Lei menciona o ite identificado, em negrito, e fonte na cor amarelo. Caso não seja mencionado, não informar.
